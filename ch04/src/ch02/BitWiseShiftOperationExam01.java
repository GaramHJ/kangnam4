...
public class BitWiseShiftOperationExam01 {
	...
	public static void main(String[] args) {
		...
		byte a = 5;
		byte b = (byte)(a<<2);//byte,short,char는 연산 시 int로 변환 후 연산에 참여함.
		...
		// 음수이면 최상위비트가 1임.
		a = 20;
		b = (byte)(a>>2);//byte,short,char는 연산 시 int로 변환 후 연산에 참여함.
		System.out.println(b);
		
		// 오른쪽 shift(>>) 2개짜리 연산 시 값이 음수면 최상위 비트가 1이므로
		// 왼쪽에 1이 채워짐.
		byte c = (byte)0xf8;//-8
		...
		//오른쪽 shift(>>>) 3개짜리는 연산 시 왼쪽에 무조건 0으로 채움.
		byte e = 20;
		byte f = (byte)(e>>>2); //5
